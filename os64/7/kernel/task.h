...
extern inline	struct task_struct * get_current()
{
...
extern void wakeup_process(struct task_struct *tsk);
...
extern void switch_mm(struct task_struct *prev,struct task_struct *next);
