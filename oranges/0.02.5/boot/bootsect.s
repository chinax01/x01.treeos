...
Init8259A:
	...
	mov al, 0x20 	; IRQ0 => 0x20, 主8259 ICW2
	out 0x21, al 
	call io_delay

	mov al, 0x28	; IRQ8 => 0x28, 从8259 ICW2 
	out 0xA1, al 
	call io_delay

	mov al, 0x04	; IR2 级联从片, 主8259 ICW3
	out 0x21, al 
	call io_delay

	mov al, 0x02 	; 对应主片 IR2, 从8259 ICW3
	out 0xA1, al 
	call io_delay

	mov al, 0x01	; 80x86 模式, 主8259 ICW4
	out 0x21, al 
	call io_delay
	...
	mov al, 0xFE	; 开启 IRQ0 时钟， 主8259 OCW1
	out 0x21, al 
	call io_delay

	mov al, 0xFF	; 屏蔽从片， 从8259 OCW1
	out 0xA1, al 
	call io_delay
...
%rep 95
	Gate SelectorCode32, SpuriousHandler, 0, DA_386IGate
%endrep 
.0x80:	Gate SelectorCode32, UserIntHandler, 0, DA_386IGate
