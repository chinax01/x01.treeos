...
int sys_setup(void)
{
	...
	if (drive == 0) {
		...
		if (start_buffer->b_data[510] != 0x55 || (unsigned char)start_buffer->b_data[511] != 0xaa) {
...
static void read_intr(void)
{
	...
	port_read(HD_DATA, this_request->bh->b_data + 512 * (this_request->nsector & 1), 256);
